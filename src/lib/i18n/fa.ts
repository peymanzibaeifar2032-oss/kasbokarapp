...
export const faIR = {
  ...
  blockInterval: "بستن ساعت خالی",
  blockHint: "وقتی آن ساعت کار نمی‌کنید: استراحت، کار شخصی یا تعطیلی. اجرای تاتو را از «ثبت اجرا» ذخیره کنید.",
  ...
  staffHint: "در این سالن اجرا فقط با پیمان زیبائی‌فر است.",
